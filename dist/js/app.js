(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".swiper-features")) new core(".swiper-features", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".main-features__button-prev",
                    nextEl: ".main-features__button-next"
                },
                on: {}
            });
            if (document.querySelector(".swiper-device")) new core(".swiper-device", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".body-main-device__button-prev",
                    nextEl: ".body-main-device__button-next"
                },
                on: {}
            });
            if (document.querySelector(".swiper-video-reviews")) new core(".swiper-video-reviews", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".main-video-reviews__button-prev",
                    nextEl: ".main-video-reviews__button-next"
                },
                on: {}
            });
